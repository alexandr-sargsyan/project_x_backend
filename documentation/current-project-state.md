...
**Последнее обновление:** Улучшения поиска: английский язык, public_summary в поиске, ранжирование по релевантности, гибкая логика поиска, поддержка коротких запросов  
...
## 📝 Последние изменения (2026-01-20)
...
- ✅ **Добавлен public_summary в поиск**
  ...
  - Поиск работает по 4 полям: `title`, `public_summary`, `search_profile`, `search_metadata`
  - Миграция: изменена `2026_01_08_171112_create_video_references_table.php`
...
- ✅ **Ранжирование по релевантности**
  ...
  - Обновлен `PostgresSearchService::buildSearchQuery()`
...
- ✅ **Гибкая логика поиска**
  ...
  - Обновлен `PostgresSearchService::prepareTsQuery()`
...
- `search_vector` (tsvector, computed column) — автоматически генерируется из `title`, `public_summary`, `search_profile`, `search_metadata` (язык: english)
...
- Ищет по полям: `title`, `public_summary`, `search_profile`, `search_metadata`
...
**Механизм:**
- Использует `tsvector` (computed column) на полях: `title`, `public_summary`, `search_profile`, `search_metadata`
...
3. **search_vector** — автоматически генерируется PostgreSQL из `title`, `public_summary`, `search_profile`, `search_metadata` (язык: english)
