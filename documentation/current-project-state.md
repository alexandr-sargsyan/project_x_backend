...
**Последнее обновление:** Добавлена система рейтинга видео (rating 0-10) для сортировки, range slider в админ-панели, колонка Rating в таблице видео  
...
## 📝 Последние изменения (2026-01-19)
...
**Сортировка:**
- По умолчанию: сортировка по `rating DESC` (высокий рейтинг первым), затем по `created_at DESC`
- Все варианты сортировки включают `rating` как вторичную сортировку для приоритизации качественных видео
- Параметр `sort_by` поддерживает значения: `rating` (по умолчанию), `quality_score`, `created_at`, `relevance`
