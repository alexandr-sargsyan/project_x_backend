...
- ✅ **Улучшен layout селекторов категорий**
  - Два селектора (Parent Category и Subcategory) размещены side-by-side в отдельном блоке "Category Selection"
  - Более интуитивный интерфейс для выбора категорий
  - Улучшена визуальная структура формы

### Предыдущие изменения (2026-01-14)

### Упрощение админ-панели
- ✅ **Упрощен выбор категорий**
  - Два отдельных селектора: "Parent Category" (слева) и "Subcategory" (справа)
  - Размещены side-by-side в отдельном блоке "Category Selection"
  - Первый селектор показывает все корневые категории
  - Второй селектор изначально пуст и disabled
  - Если у выбранной родительской категории есть подкатегории:
    - Второй селектор становится активным и обязательным
  ...
  - Если у выбранной родительской категории нет подкатегорий:
    - Второй селектор остается disabled
...
- Два селектора категорий (Parent Category и Subcategory) размещены side-by-side в отдельном блоке "Category Selection"
